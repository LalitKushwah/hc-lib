...
import { HTTP_INTERCEPTORS, HttpClient, HttpClientModule, HttpParams, HttpResponse } from '@angular/common/http';
...
var HcDirective = /** @class */ (function () {
    function HcDirective(el, hc) {
        this.el = el;
        this.hc = hc;
    }
    HcDirective.prototype.ngAfterViewInit = function () {
        console.log('View Init');
    };
    HcDirective = __decorate([
        Directive({ selector: '[hclib]' }),
        __metadata("design:paramtypes", [typeof (_a = typeof ElementRef !== "undefined" && ElementRef) === "function" && _a || Object, typeof (_b = typeof HcService !== "undefined" && HcService) === "function" && _b || Object])
    ], HcDirective);
    return HcDirective;
    var _a, _b;
}());
...
var DoSubscriber = (function (_super) {
    __extends$3(DoSubscriber, _super);
 ...
 */
var PostInterceptor = /** @class */ (function () {
...
export { HcDirective, HcService, HcModule };
//# sourceMappingURL=hc-lib.umd.js.map
